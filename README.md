...
1. 从 [**Releases**](https://github.com/ZXCWT666/deepseek-harness-desktop/releases/tag/v1.0.1) 下载 `DeepSeek Harness-1.0.1.zip`（Windows 便携版，免配置环境），解压后运行 `DeepSeek Harness.exe`，自动拉起 `http://127.0.0.1:3080`；
